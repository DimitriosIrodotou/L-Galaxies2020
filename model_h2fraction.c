...
double update_H2fraction_KMT09 (double logsigmah, double metallicity) {
	...
	mf1 = H2Fraction[ii][jj] +
	      (H2Fraction[ii + 1][jj] - H2Fraction[ii][jj]) * (metallicity - H2Fraction_Zgrid[ii]) / (H2Fraction_Zgrid[ii + 1] - H2Fraction_Zgrid[ii]);
	mf2 = H2Fraction[ii][jj + 1] + (H2Fraction[ii + 1][jj + 1] - H2Fraction[ii][jj + 1]) * (metallicity - H2Fraction_Zgrid[ii]) /
	                               (H2Fraction_Zgrid[ii + 1] - H2Fraction_Zgrid[ii]);
