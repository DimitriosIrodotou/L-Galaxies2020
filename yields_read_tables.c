...
void read_yield_tables (void)
{
	...
	sprintf (buf1, "../Development_Branch/YieldTables/%s", name1);
	...
	sprintf (buf2, "../Development_Branch/YieldTables/%s", name2);
	...
	sprintf (buf3, "../Development_Branch/YieldTables/%s", name3);
	...
	sprintf (buf4, "../Development_Branch/YieldTables/%s", name4);
	...
	sprintf (buf5, "../Development_Branch/YieldTables/%s", name5);
	...
	{
		sprintf (buf6, "../Development_Branch/YieldTables/%s", name6[i6]);
	...
	{
		sprintf (buf7, "../Development_Branch/YieldTables/%s", name7[i7]);
	...
	{
		sprintf (buf8, "../Development_Branch/YieldTables/%s", name8[k8]);
	...
	sprintf (buf9, "../Development_Branch/YieldTables/%s", name9);
	...
	sprintf (buf10, "../Development_Branch/YieldTables/%s", name10);
	...
	{
		sprintf (buf11, "../Development_Branch/YieldTables/%s", name11[i11]);
	...
	{
		sprintf (buf12, "../Development_Branch/YieldTables/%s", name12[i12]);
	...
	{
		sprintf (buf13, "../Development_Branch/YieldTables/%s", name13[k13]);
		...
		{
			for (j13 = 0; j13 < SNII_MASS_NUM;
			     j13 ++) //Number of initial masses = 85 (for Portinari yields) (11 in initial yield tables)
			{
				fscanf (fd13, "%f", &m13);
	...
	sprintf (buf17, "../Development_Branch/YieldTables/%s", name17);
	...
	sprintf (buf15, "../Development_Branch/YieldTables/%s", name15);
	...
	sprintf (buf16, "../Development_Branch/YieldTables/%s", name16);
	...
	sprintf (buf14, "../Development_Branch/YieldTables/%s", name14);
...
double Chabrier_IMF (double M)
{
	...
	{
		printf ("Chabrier_IMF(): Normalization constants for IMF not known. Check upper mass limit (SNII_MAX_MASS).");
		exit (1);
	}
